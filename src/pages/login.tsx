    ...
    <>
      <div className='place-items-center pt-40 flex flex-col space-y-4'>
        ...
        <div className="grid grid-cols-1 gap-4 place-items-center p-2"><svg width="76" height="76" viewBox="0 0 76 76" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          </div><input required type="email" placeholder="email" onChange={(e)=>setEmail(e.target.value)} className="ring-1 ring-zinc-100 p-2 text-sm text-[#474747] rounded-lg focus:outline-none focus:ring-1 focus:ring-[#969696]" />
          <div className="flex flex-col space-y-2">
            <label className="text-[#474747] text-sm">Palavrapasse</label>
            <input required type="password" onChange={(e)=>setSenha(e.target.value)} placeholder="palavra passe" className="ring-1 ring-zinc-100 p-2 text-sm text-[#474747] focus:outline-none focus:ring-1 focus:ring-[#969696] rounded-lg" />
          </div>
