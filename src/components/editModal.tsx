        ...
        <>
           ...
           focus:ring-1 focus:ring-sky-800 " />
                                    ...
                                    <div className="flex space-x-10 items-center justify-between">
                                        ...
                                        className={`bg-sky-800 w-[50%] mt-10 hover:bg-sky-700 ${!loading&&"cursor-pointer"} text-white flex justify-center p-2 
                                        rounded-lg  duration-300`}>
                                            {loading ? <span className="w-full place-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                className={`animate-spin lucide lucide-loader-circle-icon lucide-loader-circle`}>
                                                <path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg></span> : "Editar"
